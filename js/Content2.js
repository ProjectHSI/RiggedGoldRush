var data = {
				...
				"option": [
				  {
					"text": "Pay the tax.",
					"points": 10,
					"feedback": "This will cost money, but you will get to the gold fields more quickly. Lose 10 points for paying the tax. ",
					"pointsText": "Gain 10 points for getting to the goldfields quickly.",
					"action": "continue"
				  },
				  {
			  ...
			  "options": {
				"option": [
				  ...
				  },
				  {
					...
					"points": -20,
					"feedback": "Not a wise choice. This means you are not earning money while you dig, and it brings you into competition with the other miners. They do not like that.",
					"pointsText": "Lose 20 points.",
					"action": "continue"
				  }
				]
			  }
			  ...
			  "options": {
				"option": [
				  ...
				  },
				  {
					...
					"points": 20,
					"feedback": "A good decision, you should continue to make steady finds.",
					"pointsText": "Gain 20 points.",
					"action": "continue"
				  }
				]
			  ...
			  "spinner": {
				"result": [
				  ...
				  },
				  {
					"range": "9,10",
					"points": -100,
					"feedback": "You have not found any gold.",
			  ...
			  "options": {
				"option": [
				  ...
				  },
				  {
					...
					"points": 10,
					"feedback": "People who change and adapt are very brave.",
					"pointsText": "Gain 10 points.",
					"action": "continue"
				  }
				]
			  ...
			  "options": {
				"option": [
				  ...
				  },
				  {
					...
					"points": 10,
					"feedback": "A commitment to your new society.",
					"pointsText": "Gain 10 points.",
					"action": "continue"
				  }
				]
  ...
  "specialFunc":"",
   "blurb": "In your local community, there is little prejudice against the Chinese but the âWhite Australiaâ policy is developing and it has a number of intentions that will prejudice Chinese and other non-European people. --- Will you leave or stay? ",
		  ...
		  "results": [
			  {
				  "text":"Bad luck! You didnât strike it rich on the goldfields. Some Chinese survived and thrived but many did not."
			  },
			  {
				  "text":"Good work, you didnât strike it rich but you helped to build a new society. Some Chinese survived and thrived but many did not."
			  },
			  {
				...
				"option": [
				  {
					...
					"points": 10,
					"feedback": "That could work. You do not know if these people will make good miners, but you get to know them on the journey.",
					"pointsText": "Gain 10 points.",
					"action": "continue"
				  },
				  {
			  ...
			  "options": {
				"option": [
				  ...
				  },
				  {
					...
					"points": -10,
					"feedback": "You will save on transportation costs but goods are extra expensive at the goldfields.",
					"pointsText": "Lose 10 points.",
					"action": "continue"
				  }
				]
				...
				"option": [
				  {
					"text": "Pan for gold.",
					"points": -10,
					"feedback": "Unfortunately most of the gold has already been found.",
					"pointsText": "Lose 10 points.",
					"action": "continue"
				  },
				  {
				...
				"option": [
				  {
					...
					"points": 10,
					"feedback": "A good decision if you find gold, but you are giving yourself less chance of doing so.",
					"pointsText": "Gain 10 points.",
					"action": "continue"
				  },
				  {
				...
				"option": [
				  {
					...
					"points": 30,
					"feedback": "This costs a lot of money.",
					"pointsText": "Lose 20 points. However, it gives you a steady income. Gain 50 points.",
					"action": "continue"
				  },
				  {
					"text": "Save your money.",
					"points": 0,
					"feedback": "You may have missed an opportunity but you have not spent any money.",
				...
				"option": [
				  {
					...
					"points": 0,
					"feedback": "A brave and principled decision. No points lost for this decision.",
				...
				"option": [
				  {
					...
					"points": 0,
					"feedback": "All is quiet, there is no threat from anyone.",
					...
					"result": [
					  {
						"range": "1",
						"points": -1000,
						"feedback": "You are killed.",
						"pointsText": "Game over for you.",
						"action": "continue"
					  },
					  {
						"range": "2",
						"points": -20,
						"feedback": "You are wounded",
						"pointsText": "Lose 20 points.",
						"action": "continue"
					  },
					  {
						...
						"points": -10,
						"feedback": "You are safe.",
						"pointsText": "Lose 10 points for the time lost in mining.",
						"action": "continue"
					  }
					]
				  } 
  ...
  "specialFunc":"",
   "blurb": "It is time to decide if you will stay in Australia or return to Britain.",
		  ...
		  "results": [
			  {
				  "text":"Bad luck! You didnât strike it rich on the goldfields. Many miners struck out, some prospered, some strove to achieve democratic ideals.",
			  },
			  {
				  "text":"Good work, you didnât strike it rich but you helped to build a new society. Many miners struck out, some prospered, some strove to achieve democratic ideals. ",
			  },
			  {
			  ...
			  "spinner": {
				"result": [
				  ...
				  },
				  {
					"range": "9,10",
					"points": -30,
					"feedback": "You are ill and cannot work for some time.",
					"pointsText": "Lose 30 points.",
					"action": "continue"
				  },
				...
				"option": [
				  {
					...
					"points": 20,
					"feedback": "A good decision. This will bring in extra income as well as helping the community.",
					"pointsText": "Gain 20 points.",
					"action": "continue"
				  },
				  {
  ...
  "specialFunc":"",
   "blurb": "You are considering opening a refreshments tent for the miners. --- This will be extra work but it will earn you money. You will come into regular contact with miners, many of whom are very rough. ",
			  ...
			  "options": {
				"option": [
				  {
					"text": "Set up a refreshment tent.",
					"points": 20,
				...
				"option": [
				  {
					...
					"points": 0,
					"feedback": "You are sticking up for your beliefs. There is no problem so far.",
					"pointsText": "No points gained or lost.",
					"action": "continue"
				  },
				  {
  ...
  "specialFunc":"",
   "blurb": "It is Saturday night. Many miners have gathered within the stockade. --- Your husband is one of them. He asks you to come and join him. You know that authorities might attack the stockade.",
			  ...
			  "options": {
				"option": [
				  {
					"text": "Join your husband and take a stand for the rights of miners.",
					"points": 10,
					...
					"spinner": {
						"result": [
						  ...
						  },
						  {
							"range": "2",
							"points": -100,
							"feedback": "Your husband is wounded.",
							"pointsText": "Lose 100 points.",
							"action": "continue"
						  },
						  {
							"range": "3",
							"points": -100,
							"feedback": "Your husband is arrested.",
							"pointsText": "Lose 100 points.",
							"action": "continue"
							},
						  {
			  ...
			  "spinner": {
				"result": [
				  ...
				  },
				  {
					"range": "10",
					"points": -100,
					"feedback": "You have failed to find any gold.",
					"pointsText": "Lose 100 points.",
					"action": "continue"
				  }
				]
  ...
  "specialFunc":"",
   "blurb": "It is a year later. You could stay near the goldfields and help build the new community, or leave for a new place.",
		  ...
		  "results": [
			  {
				  "text":"Bad luck! You didnât strike it rich. Circumstances were against you, life was difficult for a woman on the goldfields."
			  },
			  {
				  "text":"Good work, you didnât strike it rich but you helped to build a new society. "
			  },
			  {
					...
					"spinner": {
						"result": [
						  ...
						  },
						  {
							"range": "6,7,8,9,10",
							"points": 0,
							"feedback": "He was genuine. You feel pleased.",
							"pointsText": "No points gained or lost.",
							"action": "continue"
						  },
						]
  ...
  "specialFunc":"",
   "blurb": "The gold rush is over but you could stay on in the community, working as a policeman or in another line of work. ",
		  ...
		  "results": [
			  {
				  "text":"Bad luck! You didnât strike it rich on the goldfields. At least you survived. Life on the goldfields could be dangerous for a policeman."
			  },
			  {
				  "text":"Good work, you didnât strike it rich but you stayed safe and helped to build a new society. "
			  },
			  {
